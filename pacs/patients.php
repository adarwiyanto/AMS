...
$title = 'Pasien DICOM';
$rows = db()->query('SELECT p.*, l.ams_patient_id FROM pacs_patients p LEFT JOIN pacs_link_ams_patient l ON l.dicom_patient_id = p.patient_id ORDER BY p.created_at DESC LIMIT 200')->fetchAll();
